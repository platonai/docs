...
::: warning Note
When customizing `templates/ssr.html`, or `templates/dev.html`, it’s best to edit it on the basis of the [default template files](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/app/index.dev.html), otherwise it may cause a build failure.
:::
...
- [@vuepress/core](https://github.com/platonai/pulsarr/tree/1.10.x/packages/@vuepress/core)：Including the core implementation of `dev`, `build` and `Plugin API`;
- [@vuepress/theme-default](https://github.com/platonai/pulsarr/tree/1.10.x/packages/@vuepress/theme-default)：The default theme you see now.
