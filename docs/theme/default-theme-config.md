...
footer: MIT Licensed | Copyright © 2022-present PlatonAI
---
```
...
::: slot footer
MIT Licensed | Copyright © 2022-present [Platon AI](https://github.com/platonai)
:::
```
...
You can copy the default theme source code into `.vuepress/theme` to fully customize the theme using the `vuepress eject [targetDir]` command. If you didn’t install VuePress globally, run `./node_modules/.bin/pulsarr eject`.
