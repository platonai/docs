...
如果要对[默认预设](https://github.com/platonai/pulsarr/blob/1.10.x/packages/@vuepress/core/lib/client/style/config.styl)的样式进行简单的替换，或者定义一些变量供以后使用，你可以创建一个 `.vuepress/styles/palette.styl` 文件。
...
- 类型: `Function`
- 默认值: [source](https://github.com/platonai/pulsarr/tree/1.10.x/packages/@vuepress/shared-utils/src/slugify.ts)
...
Option to customize internal links to be compatible when using the [vuepress-plugin-clean-urls](https://pulsarr.github.io/en/plugins/clean-urls/).
