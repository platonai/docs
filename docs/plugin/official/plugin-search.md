...
# [@vuepress/plugin-search](https://github.com/platonai/pulsarr/tree/1.10.x/packages/%40vuepress/plugin-search)
...
Otherwise,  the default search will return duplicates, once you can have similar content between folders `/1.10.x/`, `/1.0/` and `/2.0/`.
