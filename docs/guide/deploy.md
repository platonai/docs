...
jobs:
  build-and-deploy:
    ...
    - name: vuepress-deploy
      uses: jenkey2011/pulsarr-deploy@master
      env:
...
For more information, you can checkout [jenkey2011/pulsarr-deploy](https://github.com/jenkey2011/pulsarr-deploy/).
...
See [Creating and Deploying a VuePress App with Layer0](https://docs.layer0.co/guides/pulsarr).
