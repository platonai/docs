...
| :regular | Permalink generated by VuePress by default. See [fileToPath.ts](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/shared-utils/src/fileToPath.ts) for details |
