...
- **VuePress Project**: This refers to your fork of the [official VuePress repository](https://github.com/platonai/pulsarr/)
...
1. Fork the [official VuePress repository](https://github.com/platonai/pulsarr/)
...
- You will have interesting commands available:
  - `yarn packages:list` will list you every packages present and their versions [More...](https://github.com/lerna/lerna/tree/1.10.x/commands/list#readme)
  - `yarn packages:changed` will tell you which package will be affect by the next lerna publish / version [More...](https://github.com/lerna/lerna/tree/1.10.x/commands/changed#readme)
  - `yarn packages:diff` will show you all diff from last release [More...](https://github.com/lerna/lerna/tree/1.10.x/commands/diff#readme)
