...
HTML template path used in `dev` mode, default template see [here](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/client/index.dev.html)
...
HTML template path used in `build` mode, default template see [here](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/client/index.ssr.html)
