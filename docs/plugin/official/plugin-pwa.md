...
# [@vuepress/plugin-pwa](https://github.com/platonai/pulsarr/tree/1.10.x/packages/%40vuepress/plugin-pwa)
...
Feel free to submit PRs to improve the default [i18n configuration](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/plugin-pwa/lib/i18n.js).
