...
To apply simple overrides to the styling of the [default preset](https://github.com/platonai/pulsarr/blob/1.10.x/packages/@vuepress/core/lib/client/style/config.styl) or define some variables to use later, you can create a `.vuepress/styles/palette.styl` file.
...
- Type: `Function`
- Default: [source](https://github.com/platonai/pulsarr/tree/1.10.x/packages/@vuepress/shared-utils/src/slugify.ts)
...
Option to customize internal links to be compatible when using the [vuepress-plugin-clean-urls](https://pulsarr-community.netlify.app/en/plugins/clean-urls/).
