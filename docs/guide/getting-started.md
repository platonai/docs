...
The fastest way to get your VuePress project set up is to use our [create-vuepress-site generator](https://github.com/pulsarrjs/create-vuepress-site/), which will help scaffold the basic VuePress site structure for you.
