...
dev 模式下使用的 HTML 模板路径，默认模板见 [这里](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/client/index.dev.html)。
...
build 模式下使用的 HTML 模板路径，默认模板见 [这里](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/client/index.ssr.html)。
...
- [主题继承](./inheritance.md)
- [例子: `@vuepress/theme-vue`](https://github.com/platonai/pulsarr/tree/1.10.x/packages/@vuepress/theme-vue)
...
全局布局组件是负责管理全局布局方案的一个组件，VuePress [默认的 globalLayout](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/core/lib/client/components/GlobalLayout.vue)会帮你根据 [$frontmatter.layout](../guide/frontmatter.md#layout) 来渲染不同的布局，所以大部分情况下你不要配置此选项。
