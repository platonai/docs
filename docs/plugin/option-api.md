...
- [Internal markdown-it plugins in VuePress](https://github.com/platonai/pulsarr/blob/1.10.x/packages/%40vuepress/markdown/index.js)
...
module.exports = {
  async additionalPages () {
    ...
    const content = await rp('https://raw.githubusercontent.com/platonai/pulsarr/1.10.x/CHANGELOG.md')
    return [
      {
        path: '/changelog/',
        content
